...
public class TestAny {
	...
	public Option[] config() {
		...
		return options(
				...
				mavenBundle().groupId("com.carrotgarden.osgi")
						.artifactId("carrot-osgi-scr-conf")
						.versionAsInProject(),
				...
				mavenBundle().groupId("com.carrotgarden.conf")
						.artifactId("carrot-conf-id").versionAsInProject(),
				...
				mavenBundle().groupId("com.carrotgarden.conf")
						.artifactId("carrot-conf-file").versionAsInProject(),

				mavenBundle().groupId("com.carrotgarden.conf")
						.artifactId("carrot-conf-util").versionAsInProject(),

				mavenBundle().groupId("com.carrotgarden.conf")
						.artifactId("carrot-conf-sync").versionAsInProject(),

				//

				mavenBundle().groupId("com.carrotgarden.wrap")
						.artifactId("carrot-wrap-jgit").versionAsInProject(),
