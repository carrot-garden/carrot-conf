...
public class RepoServiceImpl implements RepoService {
	...
	public boolean ensureRepoAll() {
		...
		isReady &= ensureRepoArchon();
		isReady &= ensureRepoVersion();
		isReady &= ensureRepoMaster();
	...
	public boolean deleteRepoAll() {
		...
		isDeleted &= Util.deleteFiles(getLocalArchon());
		isDeleted &= Util.deleteFiles(getLocalMaster());
		isDeleted &= Util.deleteFiles(getLocalVersion());
